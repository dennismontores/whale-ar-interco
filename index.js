...
const initializeArButton = (button) => {
    ...
    if ((IS_IOS_CHROME || IS_IOS_SAFARI) && SUPPORTS_QUICKLOOK) {
        ...
        button.addEventListener('click', () => {
            ...
            const applePayButtonType = button.getAttribute(
            ...
            if (applePayButtonType) {
                href += `&applePayButtonType=${encodeURIComponent(
                    applePayButtonType
                )}`;
            }
            if (checkoutTitle) {
            ...
            if (checkoutSubtitle) {
                href += `&checkoutSubtitle=${encodeURIComponent(
                    checkoutSubtitle
                )}`;
            }
            if (price) {
        ...
        button.addEventListener('click', () => {
            ...
            if (fallbackUrl) {
                href += `S.browser_fallback_url=${encodeURIComponent(
                    fallbackUrl
                )};`;
            }
            href += `end;`;
